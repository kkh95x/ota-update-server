...
set_env_value "$DOCKER_ENV" "AUTH_SECRET" "$AUTH_SECRET"
set_env_value "$DOCKER_ENV" "CSRF_SECRET" "$CSRF_SECRET"
set_env_value "$DOCKER_ENV" "ROLLOUT_HASH_SECRET" "$ROLLOUT_HASH_SECRET"
set_env_value "$DOCKER_ENV" "S3_ACCESS_KEY_ID" "$MINIO_ROOT_USER"
set_env_value "$DOCKER_ENV" "S3_SECRET_ACCESS_KEY" "$MINIO_ROOT_PASSWORD"
